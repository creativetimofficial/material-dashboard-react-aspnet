    ...
    <Card>
      <CardHeader color="primary">
        ...
        <p className={classes.cardCategoryWhite}>
          ...
          <a
            target="_blank"
            href="https://www.creative-tim.com/?ref=mdr-an-notifications-page"
          >
            Creative Tim
          </a>
          . Please checkout the{" "}
            ...
            <GridContainer>
              <GridItem xs={12} sm={12} md={4}>
                ...
                <Snackbar
                  ...
                  color="info"
                  icon={AddAlert}
                  message="Welcome to MATERIAL DASHBOARD React Asp.net - a beautiful freebie for every web developer."
                  open={tl}
